...
public class adminlogin extends AppCompatActivity {
    ...
    public void AddTeacherButton(View v){
        Intent intent = new Intent(adminlogin.this, addteacher.class);
    ...
    public void attendanceRecord(View v){
        Intent intent = new Intent(adminlogin.this, admin_attendanceSheet.class);
        startActivity(intent);
    }
    ...
    public void logout(View view) {
        ...
        Intent logout=new Intent(adminlogin.this,Login.class);
